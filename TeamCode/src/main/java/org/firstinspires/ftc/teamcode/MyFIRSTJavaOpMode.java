...
//    private DistanceSensor sensorColorRange;
    ...
    public void runOpMode() {
        ...
        motorTest2 = hardwareMap.get(DcMotor.class, "testMotor2");
        motorTest3 = hardwareMap.get(DcMotor.class, "testMotor3");
        ...
        try {
            ...
            while (opModeIsActive()) {
                ...
                ServoPositionX = this.gamepad1.right_stick_x;
                ServoPositionY = this.gamepad1.right_stick_y;
                ServoMap = (ServoPositionX - ServoPositionY)*90;
                weaponPower = -this.gamepad1.right_stick_y;
                motorTest.setPower(XtgtPower - LYtgtPower);
                motorTest2.setPower(XtgtPower - RYtgtPower);
                motorTest3.setPower(weaponPower);
                telemetry.addData("X Target Power", XtgtPower);
                telemetry.addData("Motor Power", motorTest.getPower());
                telemetry.addData("Motor Power", motorTest2.getPower());
                telemetry.addData("Weapon Power", motorTest3.getPower());
                  // while(ServoMap<1) {
                   servoTest.setPosition(ServoMap);

              //}
                telemetry.addData("ServoPos", servoTest.getPosition());
                telemetry.addData("ServoMap", ServoMap);
