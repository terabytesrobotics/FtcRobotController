/*
 * Camera frame capture utility copied from SDK samples so it appears in TeamCode.
 */
...
@TeleOp(name = "Utility: Camera Frame Capture (Team)", group = "Utility")
